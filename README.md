...
This is a template web application for a Sharetribe marketplaces. You could create your own unique
...
environment type on host-services for web apps. Also, Developer Docs uses Unix-like commands in
